...
public class GraphView extends ViewPart implements IPartListener2, IViewer, IZoomableWorkbenchPart {
	...
	/** The id. */
	public static String ID = "eu.kalafatic.explorer.view.views.GraphView";

	/** The viewer. */
	private GraphViewer viewer;

	/** The Constant ROOT_NODE. */
	public static final String ROOT_NODE = "Net";
	...
	/** The content adapter. */
	private NodeGraphContentAdapter contentAdapter;

	/** The adapter. */
	private NodeGraphAdapter adapter;
	...
	public void createPartControl(Composite parent) {
		...
		EMap<String, Node> nodeMap = ExplorerModelManager.getInstance().getModel().getChildren();

		inputMap = new HashMap<String, Object>();
		inputMap.put(ROOT_NODE, nodeMap);
