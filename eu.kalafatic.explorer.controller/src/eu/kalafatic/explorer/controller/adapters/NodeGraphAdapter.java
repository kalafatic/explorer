 ...
 ******************************************************************************/
package eu.kalafatic.explorer.controller.adapters;
...
/**
 * The Class class NodeGraphAdapter.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public class NodeGraphAdapter extends AdapterImpl implements Adapter {
	...
	/**
	 * Instantiates a new node graph adapter.
	 * @param viewer the viewer
	 * @param lock the lock
	 * @param contentAdapter the content adapter
	 */
	public NodeGraphAdapter(GraphViewer viewer, ReentrantLock lock, Adapter contentAdapter) {
		this.viewer = viewer;
		this.lock = lock;
	...
	private void addNodeToSwarm(Notification notification) {
		...
		// Session swarmSession = (Session) session.eContainer()
		// .eContainer();
		//
