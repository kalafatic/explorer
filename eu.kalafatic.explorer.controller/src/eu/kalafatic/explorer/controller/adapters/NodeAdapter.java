...
/**
 * The Class class NodeAdapter.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public class NodeAdapter extends AdapterImpl implements Adapter {
	...
	/**
	 * Instantiates a new node adapter.
	 * @param viewer the viewer
	 * @param lock the lock
	 */
	public NodeAdapter(GraphViewer viewer, ReentrantLock lock) {
		this.viewer = viewer;
		this.lock = lock;
