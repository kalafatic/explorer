...
/**
 * The Class class NodeGraphContentAdapter.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public class NodeGraphContentAdapter extends EContentAdapter implements Adapter {
	...
	/**
	 * Instantiates a new node graph content adapter.
	 * @param viewer the viewer
	 * @param lock the lock
	 */
	public NodeGraphContentAdapter(GraphViewer viewer, ReentrantLock lock) {
		this.viewer = viewer;
		this.lock = lock;
