...
//
//import static eu.kalafatic.explorer.core.lib.FUIConstants.BTN_HEIGHT;
//import static eu.kalafatic.explorer.core.lib.FUIConstants.BTN_WIDTH;
//import static eu.kalafatic.explorer.core.lib.FUIConstants.LABEL_WIDTH;
//
//import java.net.URL;
...
//import eu.kalafatic.explorer.controller.hack.ImageCombo;
...
//
//		/** The WEL l_ known. */
//		WELL_KNOWN("Known", 1 << 1),
//
//		/** The PREDICT. */
//		PREDICT("Prediction", 1 << 2),
//
//		/** The DEFAULT. */
//		DEFAULT("Default", 1 << 3);
//
...
//
//	/** The section style0. */
//	int sectionStyle0 = /* Section.NO_TITLE | */Section.TITLE_BAR | Section.TWISTIE | Section.COMPACT;
//
//	/** The Constant decoratorMap. */
//	public final static Map<Control, ControlDecoration> decoratorMap = new HashMap<Control, ControlDecoration>();
//
//	// public GUIFactory(FormToolkit toolkit) {
...
//
//		gridData = new GridData(GridData.FILL_BOTH | GridData.GRAB_VERTICAL | GridData.GRAB_HORIZONTAL);
