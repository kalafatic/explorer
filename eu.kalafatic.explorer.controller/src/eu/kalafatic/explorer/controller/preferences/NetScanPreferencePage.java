...
/**
 * The Class class NetScanPreferencePage.
 * @author Petr Kalafatic
 * @project Gemini
 * @version 3.0.0
 */
public class NetScanPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	/**
	 * Instantiates a new net scan preference page.
	 */
	public NetScanPreferencePage() {
		super(GRID);
