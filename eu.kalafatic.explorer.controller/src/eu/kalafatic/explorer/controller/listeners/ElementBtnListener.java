 ...
 ******************************************************************************/
package eu.kalafatic.explorer.controller.listeners;
	...
	private void widgetSelected(Combo combo) {
		...
		try {
			...
			if (lastAction == null) {
				...
				filterPath = (String) (lastAction = file.getParentFile().getAbsolutePath());
			} else {
		...
		String path = Utils.openFile(bool[0], filterPath, new String[] { filterExt, "*.*" });
