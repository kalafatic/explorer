...
public class ScanNetDialog extends TitleAreaDialog {
	...
	public ScanNetDialog(Object element) {
		this(new Shell(Display.getDefault()), element);
	}

	public ScanNetDialog(Composite parent, Object element) {
		this(parent.getShell(), element);
	}

	public ScanNetDialog(Shell shell, Object element) {
		super(shell);
