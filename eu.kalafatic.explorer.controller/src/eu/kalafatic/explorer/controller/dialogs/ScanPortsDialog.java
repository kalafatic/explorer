...
public class ScanPortsDialog extends TitleAreaDialog {
	...
	public ScanPortsDialog(Object element) {
		this(new Shell(Display.getDefault()), element);
	}

	public ScanPortsDialog(Composite parent, Object element) {
		this(parent.getShell(), element);
	}

	public ScanPortsDialog(Shell shell, Object element) {
		super(shell);
